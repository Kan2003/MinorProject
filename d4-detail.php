    ...
    <section id="d1-details" class="section-p1">
        ...
        <div class="detail">
         ...
         <div class="detail-right">
            ...
            <h6>Dermatology</h6>
            <p>MBBS from Goa Medical College.</p>
            <p>Indore India<i class="fa-solid fa-location-dot"></i></p> <br> 
            <p><strong>EXPERIENCE <SPAN> :- </SPAN></strong>16 years</p>
            <p><strong>LANGUAGE <SPAN> :- </SPAN></strong>English , Hindi , Marathi</p>
            <p><strong>TYPE OF<SPAN> :- </SPAN></strong>Dermatology</p>
            <br><p><strong>SPECIALIST</strong></p>
            <div class="btn">
                <a href="#">    Hair Transplant Surgeon              </a>
                <a href="#">Dermatosurgeon                </a>
