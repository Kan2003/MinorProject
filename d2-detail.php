    ...
    <section id="d1-details" class="section-p1">
        ...
        <div class="detail">
         ...
         <div class="detail-left">
            ...
            <H4>D E H A R I Y A</H4>
             <p> General Surgery</p>
             <p>Bombay Hospital Indore</p>
         </div>
         <div class="detail-right">
            <h5>PROFILE</h5>
            <h3>Dr. Nilesh Kumar Dehariya
            </h3>
            <h6>General Surgery</h6>
            <p>MBBS from AIIMS Delhi</p>
            ...
            <p><strong>TYPE OF<SPAN> :- </SPAN></strong>General Surgery</p>
