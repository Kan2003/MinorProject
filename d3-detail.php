    ...
    <section id="d1-details" class="section-p1">
        ...
        <div class="detail">
         ...
         <div class="detail-right">
            ...
            <h6>Orthopaedics</h6>
            <p>MBBS from Gandhi Medical College Bhopal</p>
            <p>Indore India<i class="fa-solid fa-location-dot"></i></p> <br> 
            <p><strong>EXPERIENCE <SPAN> :- </SPAN></strong>12 years</p>
            <p><strong>LANGUAGE <SPAN> :- </SPAN></strong>English , Hindi</p>
            <p><strong>TYPE OF<SPAN> :- </SPAN></strong>Orthopaedic</p>
