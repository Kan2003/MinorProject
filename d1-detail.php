    ...
    <section id="d1-details" class="section-p1">
        ...
        <div class="detail">
         ...
         <div class="detail-left">
            ...
            <h3>DR . AMBRISH</h3>
            <H4>P A T E L</H4>
             <p>Cardiac Surgeon, Cardiologist</p>
             <p>Aurbindo Hospital Indore</p>
         </div>
         <div class="detail-right">
            <h5>PROFILE</h5>
            <h3>Dr. Ambrish S. Patel</h3>
            <h6>Cardiologist </h6>
            <p>MBBS from Mumbai</p>
            <p>Indore India<i class="fa-solid fa-location-dot"></i></p> <br> 
            <p><strong>EXPERIENCE <SPAN> :- </SPAN></strong>23 years</p>
            <p><strong>LANGUAGE <SPAN> :- </SPAN></strong>English , Hindi</p>
            <p><strong>TYPE OF<SPAN> :- </SPAN></strong>Cardiologist </p>
            <br><p><strong>SPECIALIST</strong></p>
            <div class="btn">
                <a href="#"> Cardio Thoracic</a>
