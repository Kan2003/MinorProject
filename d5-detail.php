    ...
    <section id="d1-details" class="section-p1">
        ...
        <div class="detail">
         ...
         <div class="detail-right">
            ...
            <h6>Pediatrician            </h6>
            <p>MBBS from Kerela Medical College.</p>
            <p>Indore India<i class="fa-solid fa-location-dot"></i></p> <br> 
            <p><strong>EXPERIENCE <SPAN> :- </SPAN></strong>13 years</p>
            <p><strong>LANGUAGE <SPAN> :- </SPAN></strong>English , Telegu , Hindi </p>
            <p><strong>TYPE OF<SPAN> :- </SPAN></strong>Paediatrics            </p>
